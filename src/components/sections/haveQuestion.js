...
const mockData = [
  ...
  },
  {
    ...
    content: `
    OppLoansMyOffer is not a lender and we cannot predict what fees and interest rate will be applied to the loan you will
    ...
    OppLoansMyOffer service is free of charge, and you are under no
obligation to accept the terms that the lender offers you.
  ...
  },
  {
    ...
    content: `When you accept the terms and conditions for a loan, you enter into a commitment to repay the amount you owe according to the specific schedule outlined in the documents. In the event of non-payment, additional charges may be applied. Late payment penalties vary by lender, and as OppLoansMyOffer is not involved in the lending process, we cannot supply any information on the fees you will incur if any default occurs. For more information, please contact the lender directly if you have any issues relating to your loan repayment.`
  },
  {
    id: 6,
    title: `Potential Impact on Credit Score`,
    content: `
    OppLoansMyOffer is not a lender and we do not check your credit standing and credit capacity.
  ...
  },
  {
    ...
    content: `
    OppLoansMyOffer is not a lender.
...
agreement.
    ...
    For more information visit our page for Responsible Lending. OppLoansMyOffer.com itself isn’t involved in debt collection.
  `
  },
  {
    id: 8,
